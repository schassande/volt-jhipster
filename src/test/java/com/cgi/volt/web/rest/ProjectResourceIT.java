...
class ProjectResourceIT {
    ...
    private static final String DEFAULT_VERTICAL = "AAAAAAAAAA";
    private static final String UPDATED_VERTICAL = "BBBBBBBBBB";
    ...
    void createProject() throws Exception {
        ...
        assertThat(testProject.getBu()).isEqualTo(DEFAULT_BU);
        assertThat(testProject.getSector()).isEqualTo(DEFAULT_SECTOR);
        assertThat(testProject.getVertical()).isEqualTo(DEFAULT_VERTICAL);
        assertThat(testProject.getClient()).isEqualTo(DEFAULT_CLIENT);
        assertThat(testProject.getProject()).isEqualTo(DEFAULT_PROJECT);
    }
    ...
    void getAllProjects() throws Exception {
        ...
        restProjectMockMvc
            ...
            .andExpect(jsonPath("$.[*].vertical").value(hasItem(DEFAULT_VERTICAL)))
    ...
    void getProject() throws Exception {
        ...
        restProjectMockMvc
            ...
            .andExpect(jsonPath("$.vertical").value(DEFAULT_VERTICAL))
    ...
    void putNewProject() throws Exception {
        ...
        updatedProject.bu(UPDATED_BU).sector(UPDATED_SECTOR).vertical(UPDATED_VERTICAL).client(UPDATED_CLIENT).project(UPDATED_PROJECT);
        ...
        Project testProject = projectList.get(projectList.size() - 1);
        assertThat(testProject.getBu()).isEqualTo(UPDATED_BU);
        assertThat(testProject.getSector()).isEqualTo(UPDATED_SECTOR);
        assertThat(testProject.getVertical()).isEqualTo(UPDATED_VERTICAL);
        assertThat(testProject.getClient()).isEqualTo(UPDATED_CLIENT);
        assertThat(testProject.getProject()).isEqualTo(UPDATED_PROJECT);
    }
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.bu(UPDATED_BU).client(UPDATED_CLIENT).project(UPDATED_PROJECT);
